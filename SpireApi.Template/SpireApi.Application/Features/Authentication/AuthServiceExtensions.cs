...
public static class AuthServiceExtensions
{
    ...
    /// </summary>
    public static IServiceCollection AddAspDotNetAuth(this IServiceCollection services, IConfiguration configuration, string authSettingsSectionName = "AuthSettings")
    {
