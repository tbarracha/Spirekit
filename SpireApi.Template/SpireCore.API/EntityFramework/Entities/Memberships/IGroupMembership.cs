...
public interface IGroupType<TGroupTypeId> : IAuditableEntity<TGroupTypeId>
{
    /// <summary>
...
/// <typeparam name="TUserId">The unique identifier type for the user (moderator).</typeparam>
public interface IGroupMembershipState<TStateId, TUserId> : IAuditableEntity<TStateId>
{
    /// <summary>
    ...
    /// </summary>
    TUserId? ModeratedByUserId { get; set; }
}
...
/// <typeparam name="TGroupId">The unique identifier type for the group.</typeparam>
/// <typeparam name="TUserId">The unique identifier type for the user.</typeparam>
...
public interface IGroupMember<TMemberId, TGroupId, TUserId, TRoleId, TMembershipStateId> : IAuditableEntity<TMemberId>
{
    /// <summary>
    ...
    /// </summary>
    IGroupMembershipState<TMembershipStateId, TUserId> MembershipState { get; set; }
}
...
/// <typeparam name="TMemberId">The unique identifier type for the member.</typeparam>
/// <typeparam name="TGroupId">The unique identifier type for the group.</typeparam>
/// <typeparam name="TUserId">The unique identifier type for the moderator user.</typeparam>
public interface IGroupMemberAudit<TAuditId, TMemberId, TGroupId, TUserId> : IAuditableEntity<TAuditId>
{
    /// <summary>
    /// The unique identifier of the affected group member.
    /// </summary>
    TMemberId MemberId { get; set; }
    ...
    /// </summary>
    TUserId? ModeratorUserId { get; set; }
}
