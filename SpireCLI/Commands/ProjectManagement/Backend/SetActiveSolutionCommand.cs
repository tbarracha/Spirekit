...
using static SpireCLI.Commands.ProjectManagement.Core.SpireProjectConfigManager;
using static SpireCLI.Commands.ProjectManagement.Core.SpireProjectConfigManager.SpireSolutionConfig; // For SpireSolutionConfig
...
public class SetActiveSolutionCommand : BaseSpireProjectCommand
{
    ...
    private static List<ProjectEntry> ParseSolutionProjects(string solutionPath)
    {
    ...
    private static void AssignProjectTemplates(List<ProjectEntry> projects)
    {
        foreach (var proj in projects)
            proj.Template = DetectProjectTemplate(proj.Name, proj.Path);
    }

    private static void WarnIfMissingCrucialProjects(List<ProjectEntry> projects)
    {
        ...
        FeatureSection? featuresSection)
    {
        ...
        var configFile = FindConfigFilePath();
